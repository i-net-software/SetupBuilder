# appbundler for SetupBuilder

This is a fork of the appbundler from:

  * [https://bitbucket.org/gammaproduction/appbundler](https://bitbucket.org/gammaproduction/appbundler)
  * [https://bitbucket.org/infinitekind/appbundler](https://bitbucket.org/infinitekind/appbundler)

The structure has been modified to suit the needs of SetupBuilder. The Java code is still in the same package, parallel to this README. The native code in the folder `<root>/native` together with a `build.gradle` file for compilation on macOS/OSX.
